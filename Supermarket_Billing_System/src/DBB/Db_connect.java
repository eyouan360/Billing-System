...
public class Db_connect {
 ...
 String url;
  ...
  public Db_connect(String url, String username, String password, String Host, int Port) {
...
//Fungsi untuk eksekusi query select dengan kolom spesifik
    public ResultSet querySelect(String[] nomColonne, String nomTable) {
     ...
     public ResultSet querySelect2(String[] nomColonne, String nomTable) {
...
//Overload fungsi eksekusi query delete dengan where
    ...
    public ResultSet querySelect2(String product, String string) {
